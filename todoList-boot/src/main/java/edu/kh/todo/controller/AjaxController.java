 ...
 * - 전달되는 데이터의 자료형
 * - 응답하는 데이터의 자료형
 * 위 두가지 알맞은 형태로 가공(변환)해주는 객체 \자동 변환
 * 
 * - 문자열, 숫자 <-> TEXT
 * - Map <-> JSON
 * - DTO <-> JSON
...
public class AjaxController {
	...
	@ResponseBody // 값 그대로 돌려보냄(forward/redirect 안함)
	...
	// completeCount 값을 DB에서 조회해서 그대로반환
...
//		@RequestParam("todoContent") String todoContent
	...
	// Delete방식 요청 처리 (비동기 요청만 가능!!) \동기식은 get/post만 가능
	@ResponseBody
