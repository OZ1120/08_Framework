...
public class EditBoardController {
	...
	private final BoardService boardService; // 생성자, 오토와일드 = 자동으로 의존성 주입(bean 등록)
	...
	public String boardInsert(
		 ...
		 *  						 0,1,3,4 인덱스는 저장 안됨(빈칸)
		 * 
		 * [문제점]
		 * - 파일이 선택 되지 않은 input태그도 제출 되고 있음!!
		 *   (제출은 되었는데 데이터는 ""(빈칸))
	 ...
	 * @param loginMember : 호그인한 회원이 작성한 글이 맞는지 검사하는 용도
	 ...
	 * @param logineMember : 로그인한 회원 번호 이용(로그인 == 작성자)
	 * @param images : 제출된 input type = "file"
