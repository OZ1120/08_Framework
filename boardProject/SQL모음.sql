...
VALUES(SEQ_MEMBER_NO.NEXTVAL, 
			 'member01@kh.or.kr', 
			 '$2a$10$XTMqlN9343nONHEiKmii9uda.D4hSEpN1hu5RoU64uvX0xPofcKZ2',
			 '샘플1',
			 '01012341234',
			 NULL,
			 NULL,
...
-- 이메일 중복 검사 (탈퇴 안한 회원 중 같ㅇ츤 이메일 있는지 조회)
SELECT count(*)
FROM "MEMBER" 
WHERE MEMBER_DEL_FL = '"MEMBER" m'
AND MEMBER_Email = 'member*@kh.or.kr';


DELETE FROM  "MEMBER" 
WHERE MEMBER_EMAIL = 'ieunjae096@gmail.com';
...
CREATE SEQUENCE SEQ_KEY_NO NOCACHE; -- 인증키 구분번호(시퀀스)
